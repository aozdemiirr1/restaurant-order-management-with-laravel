...
<head>
    ...
    <title>Müşteri Düzenle - Saklı Saray Admin Panel</title>
        ...
        <div class="flex-1">
            ...
            <div class="bg-white shadow-sm">
                <div class="flex justify-between items-center px-8 py-4">
                    <h1 class="text-xl font-semibold">Müşteri Düzenle</h1>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="total_orders" value="{{ $customer->total_orders }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="total_spent" value="{{ $customer->total_spent }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="notes" rows="3"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">{{ $customer->notes }}</textarea>
                            </div>
                        </div>
